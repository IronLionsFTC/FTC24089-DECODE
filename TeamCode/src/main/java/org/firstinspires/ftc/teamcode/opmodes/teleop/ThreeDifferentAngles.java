...
@TeleOp
public class ThreeDifferentAngles extends TaskOpMode {
    ...
    public Jobs spawn() {
        ...
        return Jobs.create()
                ...
                .addSeries(
                        ...
                        new RevFlywheel(shooter, 2700, 0),
                        new ShootOneNoBlock(intake, transfer, shooter, 2700, 1),
                        new ShootOneNoBlock(intake, transfer, shooter, 2700, 0),
                        new ShootOneNoBlock(intake, transfer, shooter, 2700, 1)
                )
