...
@TeleOp
public class ThreeDifferentSpeeds extends TaskOpMode {
    ...
    public Jobs spawn() {
        ...
        return Jobs.create()
                ...
                .addSeries(
                        ...
                        new RevFlywheel(shooter, 3500, 0),
                        new ShootOne(intake, transfer, shooter, 3500, 0),
                        new ShootOne(intake, transfer, shooter, 2700, 0),
                        new ShootOne(intake, transfer, shooter, 3500, 0)
                )
