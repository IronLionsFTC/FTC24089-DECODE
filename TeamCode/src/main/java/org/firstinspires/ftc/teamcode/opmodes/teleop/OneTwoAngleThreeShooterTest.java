...
@TeleOp
public class OneTwoAngleThreeShooterTest extends TaskOpMode {
    ...
    public Jobs spawn() {
        ...
        return Jobs.create()
                ...
                .addSeries(
                        ...
                        new RevFlywheel(shooter, 3200, 0),
                        new ShootOne(intake, transfer, shooter, 3200, 0),
                        new ShootOne(intake, transfer, shooter, 3200, 0),
                        new ShootOne(intake, transfer, shooter, 2700, 1)
                )
